...
public class SelectActivityTitle extends LinearLayout {
    private Button leftButton;
    private Button rightButton;
    private TextView centerTitle;

    public SelectActivityTitle(final Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        centerTitle.setText(R.string.directory);
        ...
        rightButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(v.getContext(), "Refresh poem list", Toast.LENGTH_SHORT).show();
                ActivityController.getActivity(context).finish();
                Intent intent = new Intent(context, SelectActivity.class);
                ActivityController.getActivity(context).startActivity(intent);
            }
        });
    }
}
